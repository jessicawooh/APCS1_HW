...
public class SuperArray implements ListInt
{
  ...
  //adds an item after the last item
    public boolean add( int newVal ) //changed return type to comply with ListInt
  {
    add( _size, newVal );//comply with ListInt
    return true;
  }
  ...
  //shifts elements left to fill in newly-empted slot
    public int remove( int index ) //changed return type to comply with ListInt
  {
    ...
    _size--;
    return removedVal; //comply with ListInt
  }
