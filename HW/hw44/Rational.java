...
public class Rational implements Comparable
{
	...
	if (other instanceof Rational) {
	    ...
	    reduce();
	    otherRational.reduce();
	    return (_numerator == otherRational._numerator &&
		    _denominator == otherRational._denominator);
	}
	return false;
	...
	if (!(other instanceof Rational)){
	    throw new ClassCastException("other is not a rational");
	}
	else {
	    Rational otherRational = (Rational) other;
	    int thisNumerator, otherNumerator;
	    thisNumerator = _numerator * otherRational._denominator;
	    otherNumerator = _denominator * otherRational._numerator;
